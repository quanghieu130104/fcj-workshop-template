...
* Understand Amazon EC2 in depth.
* Learn how to deploy and manage Linux servers on AWS.
...
* Understood Amazon EC2 architecture.
* Successfully connected to EC2 using SSH.
* Configured Security Groups and Key Pairs.
* Deployed the first web application on EC2.
* Managed EC2 instances using AWS CLI.